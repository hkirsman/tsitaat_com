...
<link rel="stylesheet" type="text/css" href="<?php  echo $config_q["baseurl_static"];  ?>/img/_style_header_<?php  echo $config_q["locale"];  ?>.css" media="screen, projection, print" title="" /> 
<link rel="shortcut icon" href="<?php echo (isset($this->_rootref['A_BASE_URL'])) ? $this->_rootref['A_BASE_URL'] : ''; ?>/themes/basic/favicon.ico" />
</head>
...
<div id="wrap">
  ...
  <div id="header">
    ...
    <div class="slogan">{$slogan}</div>
		<!--
    <div class="search">
      <form action="<?php echo (isset($this->_rootref['A_BASE_URL'])) ? $this->_rootref['A_BASE_URL'] : ''; ?>/otsing" id="cse-search-box">
        <div>
    ...
    -->
		<ul class="mainNav">
  		<?php $_tsitaatcom_menu_count = (isset($this->_tpldata['tsitaatcom_menu'])) ? sizeof($this->_tpldata['tsitaatcom_menu']) : 0;if ($_tsitaatcom_menu_count) {for ($_tsitaatcom_menu_i = 0; $_tsitaatcom_menu_i < $_tsitaatcom_menu_count; ++$_tsitaatcom_menu_i){$_tsitaatcom_menu_val = &$this->_tpldata['tsitaatcom_menu'][$_tsitaatcom_menu_i]; $_block2_count = (isset($_tsitaatcom_menu_val['block2'])) ? sizeof($_tsitaatcom_menu_val['block2']) : 0;if ($_block2_count) {for ($_block2_i = 0; $_block2_i < $_block2_count; ++$_block2_i){$_block2_val = &$_tsitaatcom_menu_val['block2'][$_block2_i]; ?>

        <li><a href="<?php echo $_block2_val['LINK']; ?>"><?php echo $_block2_val['NAME']; ?></a></li>
        <?php }} }} ?>
	...
	<div id="page-header">
		...
		<div class="navbar">
			...
			<ul class="linklist navlinks">
				...
				<li class="rightside"><a href="<?php echo (isset($this->_rootref['U_SEARCH'])) ? $this->_rootref['U_SEARCH'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_SEARCH_ADV_EXPLAIN'])) ? $this->_rootref['L_SEARCH_ADV_EXPLAIN'] : ((isset($user->lang['SEARCH_ADV_EXPLAIN'])) ? $user->lang['SEARCH_ADV_EXPLAIN'] : '{ SEARCH_ADV_EXPLAIN }')); ?>"><?php echo ((isset($this->_rootref['L_SEARCH_ADV'])) ? $this->_rootref['L_SEARCH_ADV'] : ((isset($user->lang['SEARCH_ADV'])) ? $user->lang['SEARCH_ADV'] : '{ SEARCH_ADV }')); ?></a></li>
			</ul>
