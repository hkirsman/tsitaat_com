...
<!-- th23 start - domain -->
<div><?php $_th23_domain_cookies_count = (isset($this->_tpldata['th23_domain_cookies'])) ? sizeof($this->_tpldata['th23_domain_cookies']) : 0;if ($_th23_domain_cookies_count) {for ($_th23_domain_cookies_i = 0; $_th23_domain_cookies_i < $_th23_domain_cookies_count; ++$_th23_domain_cookies_i){$_th23_domain_cookies_val = &$this->_tpldata['th23_domain_cookies'][$_th23_domain_cookies_i]; ?><img src="<?php echo $_th23_domain_cookies_val['URL']; ?>" width="3" height="1" alt="" title="" /><?php }} ?></div>
<!-- th23 end - domain -->
