...
<div class="panel">
	...
	<div class="content">
		...
		<?php } ?><!-- th23 start - domain --><?php if ($this->_rootref['S_TH23_DOMAIN_MULTILOGIN']) {  ?>

		<dl class="th23domain">
			<dd><label for="multilogin"><input type="checkbox" class="checkbox" name="multilogin" id="multilogin" tabindex="5"<?php if ($this->_rootref['S_TH23_DOMAIN_MULTILOGIN_PRESELECTED']) {  ?> checked="checked"<?php } if ($this->_rootref['S_TH23_DOMAIN_MULTILOGIN_FORCED']) {  ?> disabled="disabled"<?php } ?> /> <?php echo ((isset($this->_rootref['L_TH23_DOMAIN_MULTILOGIN'])) ? $this->_rootref['L_TH23_DOMAIN_MULTILOGIN'] : ((isset($user->lang['TH23_DOMAIN_MULTILOGIN'])) ? $user->lang['TH23_DOMAIN_MULTILOGIN'] : '{ TH23_DOMAIN_MULTILOGIN }')); ?></label><?php if (! $this->_rootref['S_ADMIN_AUTH']) {  ?><div class="th23domaintip"><div><?php echo ((isset($this->_rootref['L_TH23_DOMAIN_MULTILOGIN_EXPLAIN'])) ? $this->_rootref['L_TH23_DOMAIN_MULTILOGIN_EXPLAIN'] : ((isset($user->lang['TH23_DOMAIN_MULTILOGIN_EXPLAIN'])) ? $user->lang['TH23_DOMAIN_MULTILOGIN_EXPLAIN'] : '{ TH23_DOMAIN_MULTILOGIN_EXPLAIN }')); ?></div><a><?php echo ((isset($this->_rootref['L_TH23_DOMAIN_MULTILOGIN_WHAT_IS'])) ? $this->_rootref['L_TH23_DOMAIN_MULTILOGIN_WHAT_IS'] : ((isset($user->lang['TH23_DOMAIN_MULTILOGIN_WHAT_IS'])) ? $user->lang['TH23_DOMAIN_MULTILOGIN_WHAT_IS'] : '{ TH23_DOMAIN_MULTILOGIN_WHAT_IS }')); ?></a></div><?php } ?></dd>
		</dl>
		<?php } ?><!-- th23 end - domain -->
		<dl>
			<dt>&nbsp;</dt>
